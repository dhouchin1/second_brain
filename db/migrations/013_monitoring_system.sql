...
CREATE INDEX IF NOT EXISTS idx_monitoring_alerts_name ON monitoring_alerts(alert_name);
CREATE INDEX IF NOT EXISTS idx_monitoring_alerts_level ON monitoring_alerts(alert_level);
CREATE INDEX IF NOT EXISTS idx_monitoring_alerts_triggered ON monitoring_alerts(triggered_at);
CREATE INDEX IF NOT EXISTS idx_monitoring_alerts_active ON monitoring_alerts(resolved_at); -- NULL values for active alerts
...
CREATE INDEX IF NOT EXISTS idx_monitoring_health_service_timestamp ON monitoring_health_checks(service_name, timestamp);
CREATE INDEX IF NOT EXISTS idx_monitoring_health_status ON monitoring_health_checks(status);
CREATE INDEX IF NOT EXISTS idx_monitoring_health_timestamp ON monitoring_health_checks(timestamp);
...
CREATE INDEX IF NOT EXISTS idx_monitoring_perf_period ON monitoring_performance_summary(period_start, period_end);
CREATE INDEX IF NOT EXISTS idx_monitoring_perf_endpoint ON monitoring_performance_summary(endpoint);
CREATE INDEX IF NOT EXISTS idx_monitoring_perf_method ON monitoring_performance_summary(method);
...
CREATE INDEX IF NOT EXISTS idx_monitoring_security_type ON monitoring_security_events(event_type);
CREATE INDEX IF NOT EXISTS idx_monitoring_security_severity ON monitoring_security_events(severity);
CREATE INDEX IF NOT EXISTS idx_monitoring_security_timestamp ON monitoring_security_events(timestamp);
CREATE INDEX IF NOT EXISTS idx_monitoring_security_ip ON monitoring_security_events(source_ip);
...
CREATE INDEX IF NOT EXISTS idx_monitoring_system_timestamp ON monitoring_system_resources(timestamp);
...
CREATE INDEX IF NOT EXISTS idx_monitoring_daily_date ON monitoring_daily_summary(date);
...
CREATE INDEX IF NOT EXISTS idx_monitoring_app_name_timestamp ON monitoring_application_events(event_name, timestamp);
CREATE INDEX IF NOT EXISTS idx_monitoring_app_category ON monitoring_application_events(event_category);
CREATE INDEX IF NOT EXISTS idx_monitoring_app_status ON monitoring_application_events(status);
CREATE INDEX IF NOT EXISTS idx_monitoring_app_user ON monitoring_application_events(user_id);
...
-- CREATE INDEX IF NOT EXISTS idx_users_last_login ON users(last_login_at); -- Column doesn't exist
